...
$('.basket__buttons .basket__decrease__btn').click(function() {
	let $input = $(this).parent().find('.basket-quantity__input');
	let count = parseInt($input.val()) - 1;
	count = count < 1 ? 1 : count;
	$input.val(count);
});
// Прибавляем кол-во по клику
$('.basket__buttons .basket__increase__btn').click(function() {
	let $input = $(this).parent().find('.basket-quantity__input');
	let count = parseInt($input.val()) + 1;
...
$('.basket__buttons .basket-quantity__input').bind("change keyup input click", function() {
